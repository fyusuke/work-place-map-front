  ...
  <div id="review-list" >
    <div class="row" style="margin: auto 5px;">
      ...
      <div class="col-12 col-sm-10 col-md-8 col-xl-6 my-auto">
        <!-- place name -->
        <h2 class="text-center h1" style="margin: 20px auto; word-break: normal;" v-cloak>{{ name }}</h2>

        <!-- rating -->
        <div class="row" style="margin: 1rem auto">
          <!-- start rating -->
          <div class="col-4 col-sm-3 col-md-3 col-lg-3 col-xl-3 my-auto">
            <div style="text-align:center; font-size: 2rem;" class="my-auto">{{ aveRating }}</div>
            <star-rating v-model="aveRating" :show-rating="false" :increment="0.1" :read-only="true" :star-size="starSize" style="margin: 5px auto; width: 100%; justify-content: center;" v-cloak></star-rating>
          </div>
          <!-- rating bar -->
